...
<head>
    <meta charset="UTF-8">
    <title>Sửa Category - BaitapWeb</title>
</head>
<body>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-warning text-dark py-3">
                    <h5 class="card-title mb-0 fw-bold">
                        <i class="bi bi-pencil-square me-1"></i> Chỉnh sửa Category #${cate.categoryid}
                    </h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/category/update" method="post" id="categoryEditForm" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="categoryname" name="categoryname" 
                                   value="${cate.categoryname}" placeholder="Nhập tên danh mục" required autofocus>
                        ...
                        <div class="mb-3">
                            ...
                            <c:if test="${not empty cate.images}">
                                <div class="mt-2">
                                    ...
                                    <img src="${cate.images}" alt="Preview" class="rounded border" style="height: 60px; object-fit: cover;">
                                </div>
                            </c:if>
                        </div>
